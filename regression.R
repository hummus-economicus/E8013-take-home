...
# stable matches
cor(table[table$stable]$`worker productivity`, table[table$stable]$`firm productivity`, method = "pearson", use = "complete.obs")
cor(table[table$stable]$`worker FE`, table[table$stable]$`firm FE`, method = "pearson", use = "complete.obs")
cor(table[table$stable]$`worker FE`, table[table$stable]$`worker productivity`, method = "pearson", use = "complete.obs")
cor(table[table$stable]$`firm FE`, table[table$stable]$`firm productivity`, method = "pearson", use = "complete.obs")
# unstable matches
cor(table[!table$stable]$`worker productivity`, table[!table$stable]$`firm productivity`, method = "pearson", use = "complete.obs")
cor(table[!table$stable]$`worker FE`, table[!table$stable]$`firm FE`, method = "pearson", use = "complete.obs")
cor(table[!table$stable]$`worker FE`, table[!table$stable]$`worker productivity`, method = "pearson", use = "complete.obs")
